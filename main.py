...
if __name__ == "__main__":
    ...
    calliope_ciphered = operations.calliope_random_encryption(plaintext, key, [1, 1])
    calliope_deciphered = operations.calliope_random_decryption(calliope_ciphered, key, [1, 1])
    print(calliope_deciphered == plaintext)